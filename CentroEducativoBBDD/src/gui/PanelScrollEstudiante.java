...
public class PanelScrollEstudiante extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelScrollEstudiante(Profesor profesor, Materia materia, Estudiante estudiante) {
	...
	private void configuraFicha() {
		...
		this.vActual = ControladorValoracionMateria.getInstance().findByMateriaAndProfesorAndEstudiante(materia, profesor, estudiante);
	...
	public void guardaValoracion() {
		...
		if (!strValoracion.equals("")) {
			...
			ControladorValoracionMateria.getInstance().save(vActual);
		}
	}
