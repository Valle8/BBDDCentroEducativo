...
public class VentanaPrincipal extends JFrame {
	...
	public VentanaPrincipal() {
		super("Gestión del centro educativo");
	...
	private JTabbedPane getPanelPrincipal() {
		...
		jTabbedPane.add("ValoracionMateria", new PanelValoracionMateria());
		jTabbedPane.add("ValoracionMateriaList", new PanelValoracionMateriaList());
